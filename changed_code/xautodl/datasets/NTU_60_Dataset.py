...
class NTUDataset(VisionDataset):
    """`NTU Dataset`
    Args:
    ...
    cross_view_folder_name = 'cross_view'
    ...
    def __init__(
        ...
        # use 84 for cross_subject True and 88 if False
        desired_width: int = 84
    ) -> None:
        ...
        if self.use_cross_subject:
            ...
            data_root_path = os.path.join(self.root, self.base_folder, self.cross_view_folder_name)
