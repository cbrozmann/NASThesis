...
def images_to_np_array(image_paths, desired_width=75, fill_with_zeros=False, activities_from_zero=True):
...
# main function
def ntu120_get_all_data(path, desired_width=75, fill_with_zeros=False, activities_from_zero=True):
