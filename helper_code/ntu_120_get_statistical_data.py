...
skeleton_images_folder_name = 'ntu120'
...
all_train_data = ntu120_get_all_data(train_path, desired_width, fill_with_zeros)
all_test_data = ntu120_get_all_data(test_path, desired_width, fill_with_zeros)
